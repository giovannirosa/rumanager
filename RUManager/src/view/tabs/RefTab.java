...
public class RefTab extends AbstractTab {
	...
	Button limpBut = new Button("Limpar Seleção", new ImageView(Factory.getButIcon("delete.png")));
	...
	private void setActions() {
		...
		limpBut.setOnAction(e -> {
			if (Factory.showConfirmation("Tem certeza que deseja limpar a seleção de receitas?")) {
				clean();
				Factory.showWarning("Seleção de receitas limpa!");
			}
		});
